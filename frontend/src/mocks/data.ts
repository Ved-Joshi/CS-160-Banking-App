...
export const mockAccounts: BankAccount[] = [
  {
    ...
    closeEligible: false,
    balances: {
      availableBalance: 8420.14,
      currentBalance: 8642.14,
    },
  },
  {
    id: 'acct-savings',
    ...
    closeEligible: false,
    balances: {
      availableBalance: 18240.22,
      currentBalance: 18240.22,
    },
  },
  {
    id: 'acct-credit',
...
export const mockTransactions: Transaction[] = [
  {
    ...
    status: 'COMPLETED',
    type: 'Deposit',
    postedAt: '2026-03-01T15:14:00.000Z',
  },
  {
    id: 'txn-2',
    accountId: 'acct-checking',
  ...
  },
  {
    ...
    status: 'COMPLETED',
    type: 'Transfer',
    postedAt: '2026-02-27T16:40:00.000Z',
  },
  {
    id: 'txn-4',
  ...
  },
  {
    id: 'txn-5',
    accountId: 'acct-checking',
    description: 'Partner ATM Withdrawal',
    amount: 120,
    direction: 'debit',
    status: 'COMPLETED',
    type: 'ATM',
    postedAt: '2026-02-25T20:12:00.000Z',
  },
  {
    id: 'txn-6',
    accountId: 'acct-checking',
    ...
    status: 'PENDING',
    type: 'Deposit',
    postedAt: '2026-03-03T18:10:00.000Z',
  },
  {
    id: 'txn-7',
    ...
    status: 'COMPLETED',
    type: 'Transfer',
    postedAt: '2026-02-26T12:02:00.000Z',
  },
];
...
export const mockPayments: ScheduledPayment[] = [
  {
    ...
    amount: 142.87,
    cadence: 'Monthly',
    deliverBy: '2026-03-12T09:00:00.000Z',
    status: 'SCHEDULED',
  },
  {
    id: 'payment-2',
    payeeId: 'payee-3',
    payeeName: 'Vertex Property Group',
    accountId: 'acct-checking',
    amount: 2450,
    cadence: 'Monthly',
    deliverBy: '2026-03-05T09:00:00.000Z',
    status: 'PROCESSING',
  },
  {
    id: 'payment-3',
    payeeId: 'payee-2',
    payeeName: 'San Francisco Water',
    accountId: 'acct-checking',
    amount: 72.11,
    cadence: 'Once',
    deliverBy: '2026-02-20T09:00:00.000Z',
    status: 'FAILED',
  },
];
...
export const mockDeposits: Deposit[] = [
  {
    ...
    images: {
      front: {
        id: 'img-front-1',
        fileName: 'rent-front.jpg',
        capturedAt: '2026-03-03T18:08:00.000Z',
      },
      back: {
        id: 'img-back-1',
        fileName: 'rent-back.jpg',
        capturedAt: '2026-03-03T18:08:30.000Z',
      },
    },
  },
  {
